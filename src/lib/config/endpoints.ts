 ...
 * Fonte Ãºnica de verdade â€” substitui literais espalhados pelos clients.
 * Cada um pode ser sobrescrito por variÃ¡vel de ambiente.
 */
export const ENDPOINTS = {
  /** WisGate â€” Chat Completions (OpenAI-compat). */
  WISGATE_CHAT: process.env.WISGATE_CHAT_URL || "https://api.wisgate.ai/v1/chat/completions",
  /** WisGate â€” base dos modelos Gemini (relay v1beta). */
  WISGATE_GEMINI: process.env.WISGATE_GEMINI_URL || "https://api.wisgate.ai/v1beta/models",
  /** OpenRouter â€” Chat Completions (OpenAI-compat). */
...
/** Identificador de cliente HTTP enviado em integraÃ§Ãµes de relay (User-Agent / x-client). */
